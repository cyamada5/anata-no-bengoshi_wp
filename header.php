...
<body>
    ...
    <div id="nav-content">
        <nav role="navigation" class="close">
          <div id="menuToggle">
            ...
            <ul class="main-nav-list" id="main-nav">
              <li class="main-nav_item"><a href="index.html" class=""><img src="<?php echo get_template_directory_uri(); ?>/img/logo-notext.png" alt="TOPへ戻る"></i></a></li>
